Shader "FXV/FXVShieldEffect" 
{
	Properties 
	{
		_FEATURE_ActivationType ("Activation Type", Float) = -1.0
		[Toggle] _FEATURE_ColorRim ("Color Rim Enabled", Float) = -1.0
		[Toggle] _FEATURE_DirectionalVisibility ("Directional Visibility Enabled", Float) = -1.0
		[Toggle] _FEATURE_DepthOverlapRim ("Depth Overlap Rim Enabled", Float) = -1.0
		[Toggle] _FEATURE_MainTextureAnimation ("Main Texture Animation Enabled", Float) = -1.0
		[Toggle] _FEATURE_PatternTextureAnimation ("Pattern Texture Animation Enabled", Float) = -1.0
		...
		_HitRippleTex("Albedo (RGB)", 2D) = "black" {}
